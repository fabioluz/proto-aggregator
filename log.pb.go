...
func (x *ProtoLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtoLog) ProtoMessage() {}

func (x *ProtoLog) ProtoReflect() protoreflect.Message {
	mi := &file_log_proto_msgTypes[0]
...
// Deprecated: Use ProtoLog.ProtoReflect.Descriptor instead.
func (*ProtoLog) Descriptor() ([]byte, []int) {
	return file_log_proto_rawDescGZIP(), []int{0}
}

func (x *ProtoLog) GetLogId() string {
	if x != nil {
		return x.LogId
	}
	return ""
...
func (x *ProtoLog) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *ProtoLog) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_log_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x74, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x4c, 0x6f, 0x67, 0x12, 0x14,
	0x0a, 0x05, 0x6c, 0x6f, 0x67, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c,
	0x6f, 0x67, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x6d, 0x61,
...
var file_log_proto_goTypes = []interface{}{
	(*ProtoLog)(nil),              // 0: main.ProtoLog
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_log_proto_depIdxs = []int32{
	1, // 0: main.ProtoLog.timestamp:type_name -> google.protobuf.Timestamp
